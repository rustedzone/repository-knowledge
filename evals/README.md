...
Use the released version being evaluated, or replace `v0.11.0` with the exact candidate commit for an unreleased build. Keep that value identical across the pair.
