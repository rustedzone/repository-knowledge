...
func TestAgentAdapterAssetsAreEmbedded(t *testing.T) {
	...
	for _, path := range []string{
		...
		"skills/repository-knowledge/references/binary-bootstrap.md",
		"skills/repository-knowledge/scripts/install-binary.sh",
		"skills/repository-knowledge/scripts/install-binary.ps1",
		"templates/AGENTS.md",
