...
func Grade(options GradeOptions) (GradeResult, error) {
	...
	result = GradeResult{
		...
		TrialNumber:                 baseline.TrialNumber, PreflightContext: baseline.PreflightContext, HookPayload: baseline.HookPayload,
		DurationMillis: options.DurationMillis, TokenUsage: legacyTotal, Usage: usage,
